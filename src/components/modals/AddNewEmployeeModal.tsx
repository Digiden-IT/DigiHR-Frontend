...
// const EmployeeModal: React.FC<AddNewEmployeeProps> = ({
//   visible,
//   onCloseModal,
//   refetchUsers,
//   initialData,
...
//   // Set form options when data is available
//   useEffect(() => {
//     if (filterOptionsData && visible) {
//       setFormOptions({
//         departments: filterOptionsData.departments || [],
...
//         toast.success("Employee added successfully", { id: toastId });
//       } else {
//         // For editing, remove password fields and add the employee ID
//         const { password, confirmPassword, ...dataToSubmit } = formattedValues;
//         await updateUser({ id: initialData.id, ...dataToSubmit }).unwrap();
